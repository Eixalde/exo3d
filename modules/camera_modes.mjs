...
const cameraModes = function (scene, UI, star, planet, canvas) {
  ...
  const starCamera = new BABYLON.ArcRotateCamera(
    "starCamera",
    -Math.PI / 2,
    Math.PI / 3,
    starCamDist,
  ...
  const planetCamera = new BABYLON.ArcFollowCamera(
    "planetCamera",
    -Math.PI / 2,
    Math.PI / 6,
    planetCamDist,
  ...
  starCamera.collisionRadius = new BABYLON.Vector3(
    hitboxRadius,
    hitboxRadius,
    hitboxRadius
  )
  freeCamera.checkCollisions = true
  freeCamera.ellipsoid = new BABYLON.Vector3(
    hitboxRadius,
    hitboxRadius,
    hitboxRadius
  )
